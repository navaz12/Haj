<?php
  ...
  */
  ...
  $receiving_email_address = 'muhammednavazmk@gmail.com';

  if( file_exists($php_email_form = 'https://script.google.com/macros/s/AKfycbwX2Pue09CopU9HQ01P7mTuAuPZ9FrdYZH4LDtyO-Vvw79y3m0/exec' )) {
